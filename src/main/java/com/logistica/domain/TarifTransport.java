...
public class TarifTransport implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tarifTransportSequenceGenerator")
    @SequenceGenerator(name = "tarifTransportSequenceGenerator", sequenceName = "tarif-transport-seq", allocationSize = 1)
    private Long id;
