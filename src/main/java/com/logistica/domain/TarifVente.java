...
public class TarifVente implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tarifVenteSequenceGenerator")
    @SequenceGenerator(name = "tarifVenteSequenceGenerator", sequenceName = "tarif-vente-seq", allocationSize = 1)
    private Long id;
