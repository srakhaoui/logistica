...
public class FournisseurGrossiste implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fournisseurGrossisteSequenceGenerator")
    @SequenceGenerator(name = "fournisseurGrossisteSequenceGenerator", sequenceName = "fournisseur-grossiste-seq", allocationSize = 1)
    private Long id;
