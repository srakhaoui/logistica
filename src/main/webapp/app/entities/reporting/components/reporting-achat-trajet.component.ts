...
export class ReportingAchatTrajetComponent implements OnInit, OnDestroy {
  ...
  search() {
    ...
    this.reportingService.getReportingAchatTrajet(this.buildReportingRequest()).subscribe((res: HttpResponse<ILivraison[]>) => {
  ...
  export() {
    this.reportingService.exportReporting(this.buildReportingRequest(), '/achat/trajet/export');
  }
