...
import { TrajetComponent } from 'app/entities/trajet/trajet.component';
import { TrajetService } from 'app/entities/trajet/trajet.service';
import { Trajet } from 'app/shared/model/trajet.model';

describe('Component Tests', () => {
  describe('Trajet Management Component', () => {
    let comp: TrajetComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TrajetComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.trajets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
