...
import { GasoilComponent } from 'app/entities/gasoil/gasoil.component';
import { GasoilService } from 'app/entities/gasoil/gasoil.service';
import { Gasoil } from 'app/shared/model/gasoil.model';

describe('Component Tests', () => {
  describe('Gasoil Management Component', () => {
    let comp: GasoilComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GasoilComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gasoils[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
