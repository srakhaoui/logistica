...
describe('Service Tests', () => {
  describe('DepotAggregat Service', () => {
    ...
    let elemDefault: IDepotAggregat;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a DepotAggregat', () => {
      ...
      it('should update a DepotAggregat', () => {
        const returnedFromService = Object.assign(
          {
            stock: 1,
            nom: 'BBBBBB'
      ...
      it('should return a list of DepotAggregat', () => {
        const returnedFromService = Object.assign(
          {
            stock: 1,
            unite: Unite.Tonne,
      ...
      it('should delete a DepotAggregat', () => {
