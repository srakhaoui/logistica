...
import { TarifVenteComponent } from 'app/entities/tarif-vente/tarif-vente.component';
...
describe('Component Tests', () => {
  describe('TarifVente Management Component', () => {
    let comp: TarifVenteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [TarifVenteComponent],
        providers: [
          {
        ...
        .overrideTemplate(TarifVenteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tarifVentes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
